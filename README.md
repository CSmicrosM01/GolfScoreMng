...
- **ベストスコアランキング**（上位10件）
- **パット平均ランキング**
- **⭐️ パーオン率ランキング**（NEW: v2.1.0）
- **⭐️ 平均スコア変化ランキング**（NEW: v2.1.0）
  - 昨年度と今年度の平均スコアを比較
- ※すべて3回以上参加者のみ対象
...
```json
{
      ...
      "rounds": [
        {
          ...
          "course": "箱根くらかけ",
          "scores": {
            "松本": { "score": 88, "putt": 34, "parOn": 12 },
            "渡邉": { "score": 106, "putt": 39, "parOn": 8 },
            ...
          }
        }
      ],
  ...
  "handicapUpdatedAt": "2026-01-08T00:00:00.000Z",
  "cupNames": {
    "2025": "松本杯"
  }
}
